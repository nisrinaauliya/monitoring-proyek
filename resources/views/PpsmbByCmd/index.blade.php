...
@section('title', 'PPSMB by CMD - Sistem Helpdesk')
@section('page_title', 'PPSMB by CMD')
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3">
        <h6 class="mb-0 fw-semibold">Monitoring Pengajuan PPSMB - Verifikasi CMD</h6>
    </div>
            ...
            <table class="table table-hover align-middle" id="ppsmbTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('ppsmbbycmd.show', $ppsmb->id) }}" 
