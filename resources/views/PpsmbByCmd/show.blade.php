...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('ppsmbbycmd') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="card-body">
        ...
        {{-- Aksi CMD - hanya tampil jika status Verifikasi CMD/Dinov --}}
            ...
            <div class="col-md-6">
                <div class="card border-success">
                    <div class="card-body">
                        ...
                        <form action="{{ route('ppsmbbycmd.approve', $ppsmb->id) }}" method="POST">
                            @csrf
                            <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="card border-danger">
                    <div class="card-body">
                        ...
                        <form action="{{ route('ppsmbbycmd.revisi', $ppsmb->id) }}" method="POST">
                            @csrf
                            <div class="mb-3">
