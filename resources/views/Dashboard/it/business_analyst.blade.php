...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-sm-4 col-md">
        <div class="card border-0 shadow-sm h-100 ba-summary-card" role="button"
             data-key="{{ $sc['key'] }}"
            ...
            <table class="table table-hover align-middle mb-0" style="font-size:14px;">
                <thead style="background:#f8f9fa;">
                    <tr>
                        ...
                        <th class="py-3 border-0 text-muted fw-semibold">Role</th>
            ...
            <div class="card-body p-3">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-1">
                            <div>
                                ...
                                <div class="text-muted" style="font-size:14px;">
                                    {{ $p->no_ppsmb ?? '—' }}
                                    @if($pl['is_secondary'])
                                        · <span class="badge bg-secondary" style="font-size:14px;">Secondary</span>
                                    @endif
                                </div>
                            </div>
                ...
                @else
                    <div class="d-flex flex-column align-items-center justify-content-center text-center py-4">
                        ...
                        <div style="font-size:16px;font-weight:500;">Tidak ada project analisa aktif</div>
                    </div>
                @endif
            </div>
        </div>
...
(function () {
    ...
    function renderRow(p) {
        ...
        const roleBadge = p.is_primary
            ? `<span class="badge" style="background:#0d6efd;font-size:14px;">PIC BA</span>`
            : `<span class="badge bg-secondary" style="font-size:14px;">Secondary BA</span>`;
    ...
    const titleMap = {
        all:     'Semua Project',
        analisa: 'Analisa BA IT',
        antrian: 'Antrian Development',
    ...
    document.querySelectorAll('.ba-summary-card').forEach(card => {
        card.addEventListener('click', function () {
            ...
            if (activeCardKey === key) {
                ...
                activeCardKey = null;
                document.querySelectorAll('.ba-summary-card').forEach(c => {
            ...
            summaryList = allProjects.filter(p => {
                ...
                if (key === 'analisa') return p.status === 'Analisa BA IT';
                if (key === 'antrian') return p.status === 'Antrian Development';
